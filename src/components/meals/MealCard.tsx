...
export function MealCard({ meal, chef }: MealCardProps) {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden bg-white rounded-xl shadow-lg border border-gray-100">
      <div className="relative aspect-video w-full flex-shrink-0 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none" />
        
        <button className="absolute top-3 right-3 p-2 bg-white/20 backdrop-blur-sm rounded-full text-white opacity-0 group-hover:opacity-100 hover:bg-white/40 hover:text-red-500 focus:opacity-100 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white">
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <div className="mt-auto pt-4 border-t border-gray-100 flex items-end justify-between gap-4">
